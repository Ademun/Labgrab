...
func TestValidateAlphabeticString(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := user.ValidateAlphabeticString(tt.input)
			if got != tt.want {
...
func TestValidateGroupCode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := user.ValidateGroupCode(tt.input)
			if got != tt.want {
...
func TestValidatePhoneNumber(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := user.ValidatePhoneNumber(tt.input)
			if got != tt.want {
...
func TestValidateTelegramID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := user.ValidateTelegramID(tt.input)
			if got != tt.want {
